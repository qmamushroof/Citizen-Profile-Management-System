...
public class ViewBasicInformation extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == search) {
            String query = "select * from person where NID = '"+NID.getSelectedItem()+"'";
            try {
                ConnectMSSQL c = new ConnectMSSQL();
            ...
            setVisible(false);
            new UpdateBasicInformation(NID.getSelectedItem());
        } else {
            setVisible(false);
            new ViewProfile();
        }
