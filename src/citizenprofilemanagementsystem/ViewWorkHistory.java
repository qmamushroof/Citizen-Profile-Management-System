...
public class ViewWorkHistory extends JFrame implements ActionListener{
    ...
    ViewWorkHistory() {
        ...
        try {
            ...
            ResultSet rs = c.s.executeQuery("select * from WorkHistory");
            while(rs.next()) {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == search) {
            String query = "select * from WorkHistory where NID = '"+NID.getSelectedItem()+"'";
            try {
                ConnectMSSQL c = new ConnectMSSQL();
            ...
            setVisible(false);
            new UpdateWorkHistory(NID.getSelectedItem());
        } else {
            setVisible(false);
            new ViewProfile();
        }
